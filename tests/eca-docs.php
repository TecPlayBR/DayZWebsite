...
if (version_compare((string) ($m[1][0] ?? '0'), '3.3.0', '>=') && strpos($cl, '## [3.3.0]') !== false) ok('3.3.0 esta no changelog e o topo e 3.3.0 ou mais novo'); else falha('CHANGELOG sem 3.3.0', 'topo atual: ' . ($m[1][0] ?? 'nenhum'));
